...
class SequenceGRAB(Dataset):
    def __init__(
        ...
        **kwargs
        ...
        with np.load(data_path, allow_pickle=True) as data:
            self.proc_obj_name = data["proc_obj_name"]
    ...
    def __getitem__(self, index):
        ...
        proc_object_name = self.proc_obj_name[index]
        
        text = process_text(
            action_name, proc_object_name, 
            is_lhand, is_rhand, 
...
class ContactGRAB(Dataset):
    ...
    def __getitem__(self, index):
        ...
        action_name = self.action_name[index]
        object_name = self.obj_name[index]
        proc_object_name = self.proc_obj_name[index]
